/* ─────────────────────────────────────────────────────────────
   LAB301 — SEO module · DOMAIN layer
...
(function (root, factory) {
  ...
  const aiDirectivesRegistry = {
    crawlers: [
      ...
      { id: 'anthropic-ai', label: 'anthropic-ai (Anthropic)', note: 'Устаревший агент Anthropic' },
      { id: 'Amazonbot', label: 'Amazonbot (Amazon)', note: 'Alexa и AI-сервисы Amazon' },
      { id: 'YandexBot', label: 'YandexBot', note: 'Основной поисковый робот Яндекса' }
    ],
